...
public class Parser {
    public static void main(String[] args) throws Exception {
        ...
        if (args.length > 2) {
            ...
            insertToDB(context, data);
            outputStatsToFile(args[2], data);
        }
    }

    private static void insertToDB(ConfigurableApplicationContext context, Map<String, Long> data) {
    ...
    public static String toPascalCase(String str) {
        ...
        for (int i = 1; i < str.length(); i++) {
            ...
            //if previous char is a space then char i should be uppercase
            if (str.charAt(i - 1) == ' ') {
